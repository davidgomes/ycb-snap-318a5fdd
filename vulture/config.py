...
def _parse_args(args=None):
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=missing,
        help="Reuse cached analysis results. Only changed files and files"
        " that transitively import them are re-analyzed.",
    )
    parser.add_argument(
        "--cache-clear",
        action="store_true",
        default=missing,
        help="Remove all files in the cache directory before running.",
    )
    parser.add_argument(
        "--cache-dir",
        metavar="PATH",
