...
def _parse_args(args=None):
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=missing,
        help="Cache analysis results and only re-analyze changed files and"
        " files that (transitively) import them in subsequent runs.",
    )
    parser.add_argument(
        "--cache-clear",
        action="store_true",
    ...
    parser.add_argument(
        ...
        type=str,
        default=missing,
        help=f"Cache directory (default: {DEFAULTS['cache_dir']}).",
    )
    parser.add_argument(
        "--config",
        type=str,
