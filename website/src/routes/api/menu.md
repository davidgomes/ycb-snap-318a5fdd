...
- [InferRecursiveInput](/api/InferRecursiveInput/)
- [InferRecursiveOutput](/api/InferRecursiveOutput/)
...
- [RecurInput](/api/RecurInput/)
- [RecurIssue](/api/RecurIssue/)
- [RecurOutput](/api/RecurOutput/)
- [RecurSchema](/api/RecurSchema/)
- [RecursiveSchema](/api/RecursiveSchema/)
- [RecursiveSchemaAsync](/api/RecursiveSchemaAsync/)
