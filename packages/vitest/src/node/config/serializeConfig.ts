...
export function serializeConfig(project: TestProject): SerializedConfig {
  ...
  return {
    ...
    sequence: {
      ...
      sequential: globalConfig.sequence.sequential,
      maxConcurrency: globalConfig.sequence.maxConcurrency,
      affinity: globalConfig.sequence.affinity,
      durationHistory: globalConfig.sequence.durationHistory,
      durationSmoothing: globalConfig.sequence.durationSmoothing,
      analytics: globalConfig.sequence.analytics,
      analyticsPersist: globalConfig.sequence.analyticsPersist,
      durationHistorySize: globalConfig.sequence.durationHistorySize,
      adaptive: globalConfig.sequence.adaptive,
      duration: globalConfig.sequence.duration,
      balance: globalConfig.sequence.balance,
    },
