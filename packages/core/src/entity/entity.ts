...
export function createEntity(world: World, ...traits: ConfigurableTrait[]): Entity {
    return initializeEntity(world, allocateEntity(world[$internal].entityIndex), traits);
}

export function createEntityWithId(world: World, id: number, ...traits: ConfigurableTrait[]): Entity {
    return initializeEntity(world, allocateEntityWithId(world[$internal].entityIndex, id), traits);
}
