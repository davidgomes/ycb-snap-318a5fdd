...
import { getAspect, hasAspect, markAspectChanged, setAspect } from '../aspect/aspect';
...
Number.prototype.changed = function (this: Entity, trait: Trait | Aspect) {
    if (isAspect(trait)) return markAspectChanged(getEntityWorld(this), this, trait);
...
Number.prototype.get = function (this: Entity, trait: Trait | RelationPair | Aspect) {
    if (isAspect(trait)) return getAspect(getEntityWorld(this), this, trait);
...
Number.prototype.set = function (
    ...
    if (isAspect(trait)) return setAspect(getEntityWorld(this), this, trait, value, triggerChanged);
