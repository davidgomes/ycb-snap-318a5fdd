...
import { beforeMutation, deferredGet, deferredHas, getDeferredView } from '../deferred/deferred';
...
Number.prototype.add = function (this: Entity, ...traits: ConfigurableTrait[]) {
    ...
    beforeMutation(world, this, 'structure');
...
Number.prototype.has = function (this: Entity, trait: Trait | RelationPair) {
    const world = getEntityWorld(this);
    const view = getDeferredView(world, this);
    if (view) return deferredHas(world, view, trait);
...
Number.prototype.destroy = function (this: Entity) {
    const world = getEntityWorld(this);
    beforeMutation(world, this, 'destroy');
...
Number.prototype.changed = function (this: Entity, trait: Trait) {
    const world = getEntityWorld(this);
    beforeMutation(world, this, 'value');
...
Number.prototype.get = function (this: Entity, trait: Trait | RelationPair) {
    const world = getEntityWorld(this);
    const view = getDeferredView(world, this);
    if (view) return deferredGet(world, view, trait);
