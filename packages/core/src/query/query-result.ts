...
import { popDeferredScope, pushDeferredScope } from '../deferred/deferred';
...
const relationOnlyMethods = {
    ...
    updateEach(this: QueryResult<any>, world: World, callback: any) {
...
export function createRelationOnlyQueryResult<T extends QueryParameter[]>(
    ...
    const results = Object.assign(entities, {
        ...
        updateEach(this: QueryResult<any>, callback: any) {
            return relationOnlyMethods.updateEach.call(this, world, callback);
        },
