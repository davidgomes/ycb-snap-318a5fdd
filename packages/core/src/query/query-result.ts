...
import { closeDeferredScope, openDeferredScope } from '../deferred/deferred';
    ...
    const results = Object.assign(entities, {
        ...
        updateEach(
            ...
            try {
                ...
                closeDeferredScope(world, completed);
            }
...
export function createRelationOnlyQueryResult<T extends QueryParameter[]>(
    ...
    const results = Object.assign(entities, {
        ...
        updateEach(callback: any) {
            ...
            try {
                relationOnlyMethods.updateEach.call(results, callback);
                completed = true;
            } finally {
                closeDeferredScope(world, completed);
            }
