...
* Add `CookieStore`, a deterministic cookie container with domain and path matching, `Secure`, cookie prefixes, and expiry limits. Existing `Cookies` behavior is unchanged unless `CookieStore` is used.
