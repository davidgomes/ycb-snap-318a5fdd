...
use criterion::{
    Bencher, BenchmarkGroup, Criterion, criterion_group, criterion_main, measurement::WallTime,
};
use std::{
    fmt::{self, Display},
    sync::OnceLock,
...
use wasmi::{
    CompilationMode, Engine, F32, F64, Func, FuncType, Instance, Linker, Memory, Module, Store,
    TrapCode, TypedFunc, Val, ValType,
};
