...
mod core {
    ...
    pub use wasmi_core::{
        ElementSegment as CoreElementSegment, Fuel, FuelCostsProvider, FuncType as CoreFuncType,
        Global as CoreGlobal, IndexType, LimiterError, Memory as CoreMemory,
        MemoryType as CoreMemoryType, MemoryTypeBuilder as CoreMemoryTypeBuilder, RawRef, RawVal,
        ReadAs, ResourceLimiterRef, Table as CoreTable, TableType as CoreTableType, Typed,
        TypedRawRef, TypedRawVal, WriteAs, hint, wasm,
    };
}
...
pub use wasmi_core::{
    F32, F64, GlobalType, Mutability, RefType, ResourceLimiter, TrapCode, V128, ValType,
};
