...
- Directives about the compiler or the linker are not supported. The `//go:embed` directive is supported, with files read from the interpreter source filesystem.
