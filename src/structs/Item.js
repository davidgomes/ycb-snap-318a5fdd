...
export class Item extends AbstractStruct {
  ...
  integrate (transaction, offset) {
    ...
    if (this.parent) {
      if (this.parentSub !== null && !transaction._mapWriteItems.has(this)) {
        const write = recordMapWrite(transaction, this.parent, this.parentSub, 'set', this.content, this)
        if (write) markMapWriteItem(transaction, this)
      }
