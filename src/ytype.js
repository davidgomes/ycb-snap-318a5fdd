...
import { markMapWriteItem, recordMapWrite } from './utils/MapConflict.js'
...
export const typeMapDelete = (transaction, parent, key) => {
  ...
  const write = recordMapWrite(transaction, parent, key, 'delete', c?.content ?? null, c)
  if (write && c !== undefined) {
    markMapWriteItem(transaction, c)
  }
  if (c !== undefined) {
...
export const typeMapSet = (transaction, parent, key, value) => {
  ...
  const write = recordMapWrite(transaction, parent, key, 'set', content, item)
