...
const errorMessages: {
  ...
  [Errors.UsingNotInGlobal]: 'Using declaration not allowed in the global scope',
  [Errors.AwaitUsingNotInAsync]: "'await using' is only allowed inside async functions and at the top level of modules",
  [Errors.UsingMissingInitializer]: '%0 declaration must have an initializer',
  [Errors.ForInUsing]: 'Using declaration not allowed in for-in loops',
  [Errors.UsingBindingPattern]: 'Using declaration cannot have destructuring patterns',
  [Errors.UsingInSwitch]: 'Using declaration not allowed directly inside a switch case',
};
