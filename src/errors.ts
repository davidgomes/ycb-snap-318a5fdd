...
const errorMessages: {
  ...
  [Errors.UsingGlobalScope]: 'using is not allowed in the global scope',
  [Errors.AwaitUsingContext]: 'await using is only allowed inside async functions or modules',
