...
//line parser/parser.go.y:469
	...
	case 62:
		yyDollar = yyS[yypt-1 : yypt+1]
//line parser/parser.go.y:473
		{
			yyVAL.expr = yyDollar[1].expr_literals
		}
	case 63:
		yyDollar = yyS[yypt-5 : yypt+1]
//line parser/parser.go.y:477
		{
...
//line parser/parser.go.y:482
	...
	case 65:
		yyDollar = yyS[yypt-7 : yypt+1]
//line parser/parser.go.y:487
		{
			yyVAL.expr = &ast.FuncExpr{Params: yyDollar[3].func_params.Names, Defaults: yyDollar[3].func_params.Defaults, Stmt: yyDollar[6].compstmt}
			yyVAL.expr.SetPosition(yyDollar[1].tok.Position())
		}
	case 66:
		yyDollar = yyS[yypt-8 : yypt+1]
//line parser/parser.go.y:492
		{
			yyVAL.expr = &ast.FuncExpr{Params: yyDollar[3].func_params.Names, Defaults: yyDollar[3].func_params.Defaults, Stmt: yyDollar[7].compstmt, VarArg: true}
			yyVAL.expr.SetPosition(yyDollar[1].tok.Position())
		}
	case 67:
		yyDollar = yyS[yypt-8 : yypt+1]
//line parser/parser.go.y:497
		{
			yyVAL.expr = &ast.FuncExpr{Name: yyDollar[2].tok.Lit, Params: yyDollar[4].func_params.Names, Defaults: yyDollar[4].func_params.Defaults, Stmt: yyDollar[7].compstmt}
			yyVAL.expr.SetPosition(yyDollar[1].tok.Position())
		}
	case 68:
		yyDollar = yyS[yypt-9 : yypt+1]
//line parser/parser.go.y:502
		{
			yyVAL.expr = &ast.FuncExpr{Name: yyDollar[2].tok.Lit, Params: yyDollar[4].func_params.Names, Defaults: yyDollar[4].func_params.Defaults, Stmt: yyDollar[8].compstmt, VarArg: true}
			yyVAL.expr.SetPosition(yyDollar[1].tok.Position())
		}
	case 69:
		yyDollar = yyS[yypt-2 : yypt+1]
...
//line parser/parser.go.y:624
	...
	case 95:
		yyDollar = yyS[yypt-0 : yypt+1]
//line parser/parser.go.y:633
		{
			yyVAL.expr_idents = []string{}
		}
	case 96:
		yyDollar = yyS[yypt-1 : yypt+1]
//line parser/parser.go.y:637
		{
...
//line parser/parser.go.y:649
		{
			yyVAL.func_params = &ast.FuncParams{}
		}
	case 99:
		yyDollar = yyS[yypt-1 : yypt+1]
//line parser/parser.go.y:653
		{
			yyVAL.func_params = &ast.FuncParams{Names: []string{yyDollar[1].tok.Lit}, Defaults: []ast.Expr{nil}}
		}
	case 100:
		yyDollar = yyS[yypt-3 : yypt+1]
//line parser/parser.go.y:657
		{
			yyVAL.func_params = &ast.FuncParams{Names: []string{yyDollar[1].tok.Lit}, Defaults: []ast.Expr{yyDollar[3].expr}}
		}
	case 101:
		yyDollar = yyS[yypt-4 : yypt+1]
//line parser/parser.go.y:661
		{
			if len(yyDollar[1].func_params.Defaults) > 0 && yyDollar[1].func_params.Defaults[len(yyDollar[1].func_params.Defaults)-1] != nil {
				yylex.Error("invalid default argument declaration")
			}
			yyDollar[1].func_params.Names = append(yyDollar[1].func_params.Names, yyDollar[4].tok.Lit)
...
//line parser/parser.go.y:733
	...
	case 112:
		yyDollar = yyS[yypt-2 : yypt+1]
//line parser/parser.go.y:743
		{
			yyVAL.slice_count = 1
		}
	case 113:
		yyDollar = yyS[yypt-3 : yypt+1]
//line parser/parser.go.y:747
		{
			yyVAL.slice_count = yyDollar[3].slice_count + 1
		}
	case 114:
		yyDollar = yyS[yypt-1 : yypt+1]
//line parser/parser.go.y:753
		{
			yyVAL.expr_member_or_ident = yyDollar[1].expr_member
		}
	case 115:
		yyDollar = yyS[yypt-1 : yypt+1]
//line parser/parser.go.y:757
		{
...
//line parser/parser.go.y:810
	...
	case 124:
		yyDollar = yyS[yypt-0 : yypt+1]
//line parser/parser.go.y:817
		{
			yyVAL.expr_map = &ast.MapExpr{}
		}
	case 125:
		yyDollar = yyS[yypt-3 : yypt+1]
//line parser/parser.go.y:821
		{
