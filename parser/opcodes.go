...
const (
	...
	OpIndexOrMissing                 // Index; absent array/map elements are missing
	OpJumpIfNotMissing               // Jump if top is not the missing sentinel
	OpArrayTail                      // Array of elements from an index to the end
)
...
var OpcodeNames = [...]string{
	...
	OpSuspend:          "SUSPEND",
	OpDup:              "DUP",
	OpIndexOrMissing:   "IDXMIS",
	OpJumpIfNotMissing: "JMPNM",
	OpArrayTail:        "TAIL",
}
...
var OpcodeOperands = [...][]int{
	...
	OpDup:              {},
	OpIndexOrMissing:   {1},
	OpJumpIfNotMissing: {4},
	OpArrayTail:        {2},
}

// Destructure index modes for OpIndexOrMissing.
const (
	DestructureArray = 0
	DestructureMap   = 1
)
