...
class Queue(MaybeChannelBound):
    ...
    ----------
        ...
        dead_letter_exchange (str): Name of the exchange messages are
            republished to when they're rejected (without requeue),
        ...
        dead_letter_routing_key (str): Routing key used when dead-lettering
            messages.  If not set the message's original routing key is used.
    ...
    def queue_declare(self, nowait=False, passive=False, channel=None):
        ...
        if self.dead_letter_exchange is not None:
            dead_letter_options['dead_letter_exchange'] = _exchange_name(
                self.dead_letter_exchange)
        if self.dead_letter_routing_key is not None:
            dead_letter_options['dead_letter_routing_key'] = (
    ...
    def with_dead_letter(cls, name, dead_letter_exchange,
        ...
        """Create queue that dead-letters to `dead_letter_exchange`."""
        return cls(name,
