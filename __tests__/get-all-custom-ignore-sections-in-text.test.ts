...
const getCustomIgnoreSectionsInTextTestCases: customIgnoresInTextTestCase[] = [
  ...
  {
    name: 'an enable marker on its own line is protected even when no disable marker is open',
    text: dedent`
      Here is some text
      <!-- linter-enable -->
      Here is some more text
  ...
  {
    name: 'an Obsidian enable marker on its own line is protected even when no disable marker is open',
    text: dedent`
      Here is some text
      %% linter-enable %%
      Here is some more text
  ...
  {
    name: 'when a custom ignore start indicator does not follow the exact syntax and is not on its own line, it is ignored',
    text: dedent`
      Here is some text<!-- linter-disable-->here is some ignored text<!-------------         linter-enable ------>
      This content will be ignored
      So any format put here gets to stay as is
