...
from ..incremental import execution_result_from_payload, is_graphql_payload
            ...
            if answer_type in ["next", "error", "complete"]:
                ...
                if answer_type == "next" or answer_type == "error":
                    ...
                    if answer_type == "next":
                        ...
                        if not is_graphql_payload(payload):
                            raise ValueError(
                                "payload does not contain 'data' or 'errors' fields"
                            )

                        execution_result = execution_result_from_payload(payload)
