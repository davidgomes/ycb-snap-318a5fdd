...
def internal_cond(
    ...
    .. code:: python
      ...
      >>> def is_positive_number(number: int) -> Validated[int, str]:
      ...     return cond(Validated, number > 0, number, 'not positive')

      >>> assert is_positive_number(10) == Valid(10)
      >>> assert is_positive_number(-10) == Invalid(('not positive',))
