...
def result_to_validated(
    ...
    A successful value stays successful.
    A failure is wrapped into a one-element error tuple.
...
def validated_to_result(
    ...
    A successful value stays successful.
    The failure value is the whole error tuple.
    ...
    """
    if isinstance(validated_container, Valid):
