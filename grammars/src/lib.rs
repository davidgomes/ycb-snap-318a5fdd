    ...
    fn sql_parse_attempts_error() {
        ...
        assert_eq!(
            ...
            [
                ...
                r#"    note: expected one of tokens: WHITESPACE, `"`, `BUILTIN_RULE`, `PRIMARY`"#,
        ...
        assert_eq!(
            ...
            [
                ...
                "  |",
                "  = error: parsing error occurred.",
                "    note: expected one of tokens: WHITESPACE, `''`, `'`, `BUILTIN_RULE`",
        ...
        assert_eq!(
            ...
            [
                ...
                "  |",
                "  = error: parsing error occurred.",
                r#"    note: expected one of tokens: WHITESPACE, `"`, `$`, `''`, `'`, `(`, `+`, `-`, `0..9`, `?`, `BUILTIN_RULE`, `CAST`, `EXISTS`, `FALSE`, `NOT`, `NULL`, `TRUE`"#,
