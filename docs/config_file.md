...
### Config-level options:
    ...
    tap_show_launcher_summary    [Boolean] include a per-launcher pass/fail/skip summary in TAP output
    ...
    xunit_include_launcher_properties [Boolean] include launcher pass/fail properties in xunit XML output
