...
|:white_check_mark:[brokenDocLink](#brokendoclink)|Detects doc-comment symbol links that refer to unknown symbols|
...
Detects doc-comment symbol links that refer to unknown symbols.
