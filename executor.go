...
// formats are "json", "dot" and "text". By default, "json" is used.
...
// WithGraphReverse tells [Executor.Graph] to invert the graph and show the
// tasks that depend on the given tasks instead of their dependencies.
...
// WithGraphNoStatus tells [Executor.Graph] not to check whether tasks are
// up-to-date.
