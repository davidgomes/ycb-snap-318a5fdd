...
class Buffer(object):
    ...
    def set_watermarks(self, high=None, low=None):
        ...
        Sets the high and low water marks of the buffer, used for flow
        control.  Passing :const:`None` unsets the respective mark.
        ...
        Example:
            ...
            ...
            ValueError: low water mark (2) must not exceed high water mark (1)
        """
        if high is not None and low is not None and low > high:
            raise ValueError('low water mark (%r) must not exceed high water mark (%r)' % (low, high))
