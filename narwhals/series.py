...
class Series(Generic[IntoSeriesT]):
    ...
    def rolling_min(
        ...
        Examples:
            ...
            >>> import narwhals as nw
            >>>
            >>> s_native = pd.Series([4.0, 2.0, 3.0, 1.0])
    ...
    def rolling_max(
        ...
        Examples:
            ...
            >>> import narwhals as nw
            >>>
            >>> s_native = pa.chunked_array([[4.0, 2.0, 3.0, 1.0]])
    ...
    def rolling_median(
        ...
        Examples:
            ...
            >>> import narwhals as nw
            >>>
            >>> s_native = pl.Series([4.0, 2.0, 3.0, 1.0])
        ...
        *,
        ...
        Arguments:
            ...
            interpolation: Interpolation method to use when the quantile lies between
                two data points. One of `'nearest'`, `'higher'`, `'lower'`, `'midpoint'`,
                `'linear'`.
            min_samples: The number of values in the window that should be non-null before
                computing a result. If set to `None` (default), it will be set equal to
                `window_size`. If provided, it must be a strictly positive integer, and
