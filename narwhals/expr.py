...
class Expr:
    ...
    def rolling_min(
        ...
        A window of length `window_size` will traverse the values. The resulting values
        will be aggregated to their minimum. Null inputs are excluded from the window;
        a window with fewer than `min_samples` non-null values produces null.
    ...
    def rolling_max(
        ...
        A window of length `window_size` will traverse the values. The resulting values
        will be aggregated to their maximum. Null inputs are excluded from the window;
        a window with fewer than `min_samples` non-null values produces null.
    ...
    def rolling_median(
        ...
        A window of length `window_size` will traverse the values. The resulting values
        will be aggregated to their median. Null inputs are excluded from the window;
        a window with fewer than `min_samples` non-null values produces null.
    ...
    def rolling_quantile(
        ...
        *,
        ...
        Info:
            ...
            so `rolling_quantile` with `.over()` is not available on DuckDB.

        Arguments:
            window_size: The length of the window in number of elements. It must be a
                strictly positive integer.
            quantile: Quantile to compute. Must be between 0.0 and 1.0.
        ...
        Examples:
            ...
            ...         window_size=3, quantile=0.75, min_samples=1
            ...     )
            ... )
            ┌──────────────────────────┐
            |    Narwhals DataFrame    |
