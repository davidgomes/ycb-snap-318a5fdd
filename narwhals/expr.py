...
class Expr:
    ...
    def rolling_min(
        ...
        Examples:
            ...
            >>> df = nw.from_native(df_native)
            >>> df.with_columns(
            ...     b=nw.col("a").rolling_min(window_size=3, min_samples=1)
    ...
    def rolling_max(
        ...
        Examples:
            ...
            >>> df = nw.from_native(df_native)
            >>> df.with_columns(
            ...     b=nw.col("a").rolling_max(window_size=3, min_samples=1)
            ... ).to_native()  # doctest: +SKIP
        """
        window_size, min_samples = _validate_rolling_arguments(
            window_size=window_size, min_samples=min_samples
    ...
    def rolling_median(
        ...
        Examples:
            ...
            >>> df = nw.from_native(df_native)
            >>> df.with_columns(
            ...     b=nw.col("a").rolling_median(window_size=3, min_samples=1)
            ... ).to_native()  # doctest: +SKIP
        """
        window_size, min_samples = _validate_rolling_arguments(
            window_size=window_size, min_samples=min_samples
