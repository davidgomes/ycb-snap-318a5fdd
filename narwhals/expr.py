...
class Expr:
    ...
    def rolling_min(
        ...
        Null inputs are excluded from the window. A window with fewer than `min_samples`
        non-null values produces null.
    ...
    def rolling_quantile(
        ...
        *,
        ...
        Info:
            ...
            DuckDB does not support `percentile_cont` as a windowed aggregate, so
            `rolling_quantile` followed by `Expr.over` is not available on DuckDB.
