...
class Expr:
    ...
    def rolling_min(
        ...
        Null values are excluded from the window. If a window contains fewer than
        `min_samples` non-null values, the result is null.
    ...
    def rolling_quantile(
        ...
        *,
        ...
        A window of length `window_size` will traverse the values. The resulting values
        will be aggregated to the requested quantile.
        ...
        Notes:
            ...
            so `rolling_quantile` with `Expr.over` is not available for the DuckDB backend.

        Arguments:
            window_size: The length of the window in number of elements. It must be a
                strictly positive integer.
            quantile: Quantile between 0.0 and 1.0.
            interpolation: Interpolation method. One of `'linear'`, `'lower'`,
