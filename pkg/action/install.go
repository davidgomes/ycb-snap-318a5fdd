...
func (i *Install) RunWithContext(ctx context.Context, ch ci.Charter, vals map[string]any) (ri.Releaser, error) {
	...
	if err := chartutil.ProcessDependenciesWithStrategies(chrt, vals, i.MergeStrategies, i.MergeKeys, false); err != nil {
	...
	valuesToRender, err := util.ToRenderValuesWithStrategyOverrides(chrt, vals, options, caps, i.SkipSchemaValidation, util.StrategyOverrides{
