...
func addValueOptionsFlags(f *pflag.FlagSet, v *values.Options) {
	...
	f.StringArrayVar(&v.MergeStrategies, "merge-strategy", []string{}, "override chart array merge strategy (path=append|merge)")
	f.StringArrayVar(&v.MergeKeys, "merge-key", []string{}, "override chart array merge key (path=field)")
}
