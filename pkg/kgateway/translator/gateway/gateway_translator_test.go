...
func TestBasic(t *testing.T) {
	...
	t.Run("TrafficPolicy with consistent hash inherited from route", func(t *testing.T) {
		test(t, translatorTestCase{
			inputFile:  "traffic-policy/consistent-hash-inheritance.yaml",
			outputFile: "traffic-policy/consistent-hash-inheritance.yaml",
			gwNN: types.NamespacedName{
				Namespace: "default",
				Name:      "example-gateway",
			},
