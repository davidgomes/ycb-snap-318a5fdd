...
`
	...
	for _, msg := range linter.Messages {
		...
		if !strings.Contains(msg.Err.Error(), "merge") && !strings.Contains(msg.Err.Error(), "unsupported") && !strings.Contains(msg.Err.Error(), "not found") && !strings.Contains(msg.Err.Error(), "non-array") {
			continue
		}
