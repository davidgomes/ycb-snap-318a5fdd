  ...
  it("extracts session_id from assistant messages when hasReceivedInit is true", () => {
    ...
    const assistantMessage: SDKMessage = {
      ...
      message: {
        ...
        stop_sequence: null,
        usage: { input_tokens: 10, output_tokens: 5, cache_creation_input_tokens: 0, cache_read_input_tokens: 0, server_tool_use: { web_search_requests: 0 }, service_tier: "standard" },
      },
