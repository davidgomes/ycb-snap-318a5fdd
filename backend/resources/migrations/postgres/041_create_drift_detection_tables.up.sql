CREATE TABLE IF NOT EXISTS environment_baselines (
    id TEXT PRIMARY KEY, created_at TIMESTAMP NOT NULL, updated_at TIMESTAMP,
    environment_id TEXT NOT NULL, name TEXT NOT NULL, description TEXT,
    created_by TEXT, container_configs TEXT, captured_at TIMESTAMP NOT NULL,
...
CREATE TABLE IF NOT EXISTS drift_records (
    ...
    detected_at TIMESTAMP NOT NULL, resolved_at TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS compliance_snapshots (
    ...
    low_drifts INTEGER NOT NULL DEFAULT 0, compliance_score DOUBLE PRECISION NOT NULL DEFAULT 100
);
