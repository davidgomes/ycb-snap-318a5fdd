...
type Settings struct {
	...
	DriftDetectionEnabled        SettingVariable `key:"driftDetectionEnabled" meta:"label=Drift Detection;type=boolean;category=internal;description=Enable container drift detection"`
	DriftDetectionInterval       SettingVariable `key:"driftDetectionInterval" meta:"label=Drift Detection Interval;type=cron;category=internal;description=How often to detect container drift"`
