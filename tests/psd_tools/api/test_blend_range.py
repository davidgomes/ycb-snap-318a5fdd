...
class TestBlendIfCompositing:
    def test_default_blend_if_does_not_block(self) -> None:
        ...
        comp = Compositor(viewport, backdrop, 1.0, layer_filter=lambda _ly: True)
    ...
    def test_blend_if_excludes_dark_pixels(self) -> None:
        ...
        viewport = psd.viewbox
        comp = Compositor(viewport, (0.8, 0.8, 0.8), 1.0, layer_filter=lambda _ly: True)
        comp.apply(layer)
    ...
    def test_blend_if_split_linear_fade(self) -> None:
        ...
        viewport = psd.viewbox
        dark_bg = (0.2, 0.2, 0.2)
        comp_dark = Compositor(viewport, dark_bg, 1.0, layer_filter=lambda _ly: True)
        ...
        comp_mid = Compositor(viewport, mid_bg, 1.0, layer_filter=lambda _ly: True)
    ...
    def test_blend_if_luminosity_excludes_bright(self) -> None:
        ...
        comp = Compositor(viewport, bright_bg, 1.0, layer_filter=lambda _ly: True)
        comp.apply(layer)
