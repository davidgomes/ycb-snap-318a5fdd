...
cursor.executemany(request.form["q"])
"""
...
class TaintAnalyzerTests(unittest.TestCase):
    ...
    def test_import_aliases(self):
        findings = taint.TaintAnalyzer(ALIASES).run()
        self.assertEqual(3, len(findings.get("B621", ())))
        self.assertEqual(2, len(findings.get("B623", ())))
