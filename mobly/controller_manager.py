...
class ControllerManager:
  ...
  def get_controller_objects(self, controller_config_name):
    """Gets the objects registered for a controller config name.
    ...
    Returns:
      A shallow copy of the list of registered objects, or None if no
      controller module with this config name has been registered.
    """
