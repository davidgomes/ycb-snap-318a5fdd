...
class TableVectorizer(TransformerMixin, BaseEstimator):
    ...
    kind_to_columns_ : dict
        ...
        names of all datetime columns. ``kind_to_columns_['duration']`` contains
        the names of all duration columns.
    ...
    - `duration`: durations (pandas ``timedelta64``, polars ``Duration``).
