...
class ToStr(SingleColumnTransformer):
    ...
    >>> to_str.fit_transform(pd.to_timedelta(pd.Series(['2 days'])))
    Traceback (most recent call last):
        ...
    skrub._single_column_transformer.RejectColumn: Refusing to convert None with dtype 'timedelta64[...]' to strings.
