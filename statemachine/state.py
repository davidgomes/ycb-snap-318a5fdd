...
from .state_data import validate_data_spec
...
class State:
    ...
    Args:
        ...
        data: Optional mapping of string keys to default values owned by this state.
            Values are copied (or produced by a factory) on each entry and removed on exit.
            Use :class:`~statemachine.state_data.DataVar` for typed variables. Plain
            callables are treated as factories.
    ...
    def __init__(
        ...
        self._id: str = ""
        self.data = validate_data_spec(data)
