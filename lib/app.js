...
module.exports = class App extends EventEmitter {
  ...
  getExitCode() {
    ...
    if (typeof this.reporter.hasBailed === 'function' && this.reporter.hasBailed()) {
      ...
      let testsRanBeforeBail = bailReport.testsRanBeforeBail;
      let bailReason = this.reporter.bailReason;
      let bailError = new Error('Bailed on ' + bailReason + ' after running ' + testsRanBeforeBail + ' tests.');
      bailError.hideFromReporter = true;
      return bailError;
    }
