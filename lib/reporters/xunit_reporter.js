...
module.exports = class XUnitReporter {
  ...
  summaryDisplay() {
    ...
    if (this.bailInfo) {
      rootNode.appendChild(this.getBailPropertiesNode(doc, this.bailInfo));
    }
    ...
    if (this.bailInfo) {
      var bailOut = displayutils.bailOutLine(this.bailInfo);

      var errorNode = doc.createElement('error');
      errorNode.setAttribute('message', bailOut);
      rootNode.appendChild(errorNode);

      var systemOutNode = doc.createElement('system-out');
      var bailSummary = [bailOut].concat(displayutils.bailSummaryLines(this.bailInfo)).join('\n');
  ...
  getBailPropertiesNode(document, bailInfo) {
