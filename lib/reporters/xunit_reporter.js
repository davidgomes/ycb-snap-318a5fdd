...
module.exports = class XUnitReporter {
  ...
  summaryDisplay() {
    ...
    if (this.bailed) {
      rootNode.setAttribute('errors', `${this.bailCount || 1}`);
    }
