  ...
  finish() {
    ...
    if (this.bailed) {
      ...
      this.out.write(teamcityLine('buildStatisticValue', {
        key: 'bailedTests',
        value: this.bailedTests === null || this.bailedTests === undefined ? '0' : String(this.bailedTests)
      }));
      this.out.write(teamcityLine('buildStatisticValue', {
        key: 'testsBeforeBail',
        value: String(this.testsRanBeforeBail)
      }));
      this.out.write(teamcityLine('buildStatisticValue', {
        key: 'suppressedAfterBail',
        value: String(this.suppressedAfterBail)
      }));
      this.out.write(teamcityLine('buildProblem', {
        description: escape(this.bailReason === null || this.bailReason === undefined ? '' : String(this.bailReason)),
        identity: 'bail'
      }));
    }
